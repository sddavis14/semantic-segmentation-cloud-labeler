/**
 * Modified TrackballControls for Point Cloud Labeling Tool
 * Based on Three.js r128 TrackballControls
 * 
 * MODIFICATIONS:
 * - Left-click is FREE (for point selection)
...
(function () {
    ...
    class TrackballControls extends THREE.EventDispatcher {
        ...
        constructor(object, domElement) {
            ...
            this.noRotate = false;
            this.noZoom = false;
            this.noPan = false; // MODIFIED: Enable panning with Shift+Right-click
            ...
            // MODIFIED: Button mappings no longer used directly - see onMouseDown
            this.mouseButtons = {
                LEFT: null,  // Free for selection
            ...
            // MODIFIED: Remapped mouse buttons
            // - Left click (button 0): FREE - do nothing, let selection system handle it
            // - Middle click (button 1): ZOOM
            // - Right click (button 2): ROTATE (or PAN if Shift is held)
            function onMouseDown(event) {
                ...
                if (_state === STATE.NONE) {
                    ...
                    switch (event.button) {
                        ...
                        case 0: // Left click - FREE for selection
                            // Do not set any state, let the event pass through
                            return;
                        ...
                        case 2: // Right click - ROTATE (or PAN with Shift)
                            event.preventDefault();
                            if (event.shiftKey) {
                                _state = STATE.PAN;
                            } else {
